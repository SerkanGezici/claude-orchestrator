...
MANDATORY RULES:
- Independently verify each finding — do NOT blindly accept
- Look for: wrong file references, severity inflation, outdated claims, missing context
- If you genuinely confirm a finding, provide YOUR OWN evidence (not just "I agree")
- A finding verified by multiple AIs with independent evidence becomes STRONGER
